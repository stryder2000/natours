        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              token = res.data.resetURL.split('resetPassword/')[1];
              window.setTimeout(function () {
                location.assign("/password-reset/".concat(token));
              }, 1500);
            }
...
var passwordReset = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(password, confirmPassword) {
    var token, res;
  ...
  return function passwordReset(_x5, _x6) {
