...
})(
  {
          ...
          e.forEach(function (e) {
            ...
            (a.className = 'marker'),
              ...
              new mapboxgl.Popup({ offset: 30 })
                .setLngLat(e.coordinates)
                .setHTML('<p>Day '.concat(e.day, ' : ').concat(e.description))
                .addTo(o),
              t.extend(e.coordinates);
          }),
            o.fitBounds(t, {
              padding: { top: 200, left: 100, right: 100, bottom: 150 },
            });
        };
    ...
    mnjM: [
      function (require, module, exports) {
        ...
        var a = (function () {
          var t = n(
            regeneratorRuntime.mark(function t(s, n) {
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 3:
                        'success' === (n = t.sent).data.status &&
                          ((0, r.showAlert)('success', n.data.message),
                          n.data.resetURL.split('resetPassword/')[1]),
                          (t.next = 10);
                        break;
                      case 7:
                        (t.prev = 7),
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.prev = 0),
                          (a = document.querySelector('body').dataset.token),
                          (t.next = 4),
                          (0, e.default)({
                            method: 'PATCH',
                            url: '/api/v1/users/resetPassword/'.concat(a),
                            data: { password: s, confirmPassword: n },
                          })
                        );
                      case 4:
                        'success' === t.sent.data.status &&
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 8:
                          (t.prev = 8),
                            (t.t0 = t.catch(0)),
                            (0, r.showAlert)('error', t.t0.message);
                        case 11:
                        case 'end':
                          return t.stop();
                      }
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          ...
                          (o = '/api/v1/reviews/' + n),
                          (t.next = 4),
                          (0, e.default)({ method: 'DELETE', url: o })
                        );
                      case 4:
                        204 === t.sent.status &&
                          ((0, r.showAlert)(
          ...
          a &&
            a.addEventListener('submit', function (e) {
              ...
              s.append('name', document.getElementById('name').value),
                ...
                s.append('password', document.getElementById('password').value),
                s.append(
                  'confirmPassword',
                  document.getElementById('confirm-password').value
                ),
                (document.getElementById('signup').textContent =
                  'Signing up...'),
                (0, r.signup)(s);
            }),
          q && q.addEventListener('click', r.logout),
          j &&
            ...
            y.addEventListener('click', function (e) {
              ...
              if (
                (document.getElementById('star1').checked
                  ...
                  ? (o = 4)
                  : document.getElementById('star5').checked && (o = 5),
                r && 0 != o)
              ) {
                var t = { review: r, rating: o, tour: s };
                (0, u.addReview)(t);
              }
            }),
          f &&
